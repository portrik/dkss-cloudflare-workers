/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e70617db4571100ccbe71b8bca0dd31c)
// Runtime types generated with workerd@1.20250906.0 2025-05-07 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		WEBAUTHN_APP_NAME: "DKSS Example";
		DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEBAUTHN_APP_NAME" | "DATABASE_URL" | "WEBAUTHN_RP_ID">> {}
}
